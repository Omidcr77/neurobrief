...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      result = result.filter(item => 
        ...
        (item.summaryOptions?.focus && item.summaryOptions.focus.toLowerCase().includes(term)) ||
        (item.input && item.input.toLowerCase().includes(term)) ||
        (item.inputFileName && item.inputFileName.toLowerCase().includes(term))
      );
    }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setSummaries(prev => prev.filter(s => s._id !== summaryToDelete._id));
      setToastMessage({
        type: "success",
  ...
  const downloadPdf = useCallback(async (item) => {
    try {
      ...
      doc.text(`Generated: ${new Date(item.createdAt).toLocaleString()}`, margin, y);
      y += 8;
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <header className="text-center sm:text-left">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400 bg-white/50 dark:bg-gray-800/50 px-4 py-2 rounded-lg">
              {filteredSummaries.length} of {summaries.length} item{summaries.length === 1 ? "" : "s"} shown
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full py-2.5 px-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            ...
            >
              <div className="p-5 sm:p-6 flex-grow">
                ...
                <h3
                  ...
                  title={item.summaryOptions?.focus || `Summary (${formatLength(item.summaryOptions?.length)})`}
                >
        ...
        {!filteredSummaries.length && summaries.length > 0 && (
          <div className="text-center py-16">
            ...
            <button
              onClick={clearFilters}
              className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg font-medium bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800 transition-colors"
            >
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="flex items-center px-3 py-1.5 text-sm bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-lg transition-colors"
