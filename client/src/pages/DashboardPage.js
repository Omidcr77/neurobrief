    ...
    <div className="p-6 space-y-8 dark:bg-gray-900 dark:text-gray-200 min-h-screen">
            ...
            {!isEditing ? (
              ...
              <>
                ...
                <button
                  ...
                  className="
                    px-4 py-1 bg-gray-300 dark:bg-gray-600
                    text-gray-800 rounded hover:bg-gray-400
      ...
      <section className="max-w-4xl mx-auto space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="
            bg-indigo-600 text-white px-3 py-1 rounded-full text-sm
          ">
            {summaries.length}{' '}
            ...
            {summaries.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="
                    mt-4 text-indigo-600 hover:underline
          ...
          ">
            ...
            >
              <Dialog.Panel className="
                ...
                align-middle bg-white dark:bg-gray-800 
                ...
                ">
                  <button
                    ...
                    className="
                      ...
                      text-sm font-medium bg-green-500 
                  ...
                  <button
                    ...
                    className="
                      inline-flex justify-center px-4 py-2 
                      text-sm font-medium bg-gray-300 
                      dark:bg-gray-600 text-gray-800 
              ...
              ">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                  <button
                    ...
                    disabled={pwdLoading}
                    className="
                      px-4 py-2 bg-gray-300 dark:bg-gray-600
                      text-gray-800 rounded hover:bg-gray-400
                      dark:hover:bg-gray-500 transition
                      disabled:opacity-50
                    "
                  ...
                  <button
                    ...
                    className="
                      ...
                      flex items-center gap-2 hover:bg-indigo-700
